...
// outcome.js
// Shape registry (example structure)
// Each shape: { id, type, x, y }

const shapes = []; // your generator will push into this

// -------------------------------
// 1. lastIndexOf for shape types
// -------------------------------
...
// -------------------------------
// 2. Find closest circle to a given circle
// -------------------------------
...
// ---------------------------------------------
// 3. Minimal line functional (straight segment)
// ---------------------------------------------
...
// ------------------------------------------------------
// 4. Full pipeline: last circle → closest circle → line
// ------------------------------------------------------
function computeCircleLink(shapes) {
...
// ------------------------------------------------------
// 5. SVG line generator (optional)
// ------------------------------------------------------
function svgLine(lineObj) {
    if (!lineObj) return "";
    return `
        <line 
            x1="${lineObj.x1}" 
...
// ------------------------------------------------------
// 6. Main export for your outcome.html
// ------------------------------------------------------
export function generateOutcomeSVG() {
    const link = computeCircleLink(shapes);
    return svgLine(link);
}

// ------------------------------------------------------
// 7. API for adding shapes externally
// ------------------------------------------------------
export function addShape(type, x, y) {
    shapes.push({
        id: shapes.length,
        type,
        x,
